...
export const ClipRerenderModal: React.FC<Props> = ({
  jobId, clipIndex, clipTitle, initialAspectRatio, initialCanvasConfig,
  ...
  const handleSave = async () => {
    setSaving(true);
    try {
      const res = await axios.post(`${API_URL}/jobs/${jobId}/clips/${clipIndex}/rerender`, {
        words,
      ...
      onRerenderStart(res.data.job_id);
    } catch (e) {
      console.error(e);
