...
import { DEFAULT_SUBTITLE_CONFIG, SUBTITLE_PRESETS } from "../../types/subtitle";
import type { SubtitleConfig } from "../../types/subtitle";
...
const presetLabels: Record<string, string> = {
  "subtitle_preset.viral_pop": "Viral Pop",
  "subtitle_preset.podcast": "Podcast Highlight",
  "subtitle_preset.minimalist": "Minimalist",
};
      ...
      <div className="space-y-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
          {Object.entries(SUBTITLE_PRESETS).map(([key, preset]) => (
            ...
            >
              {preset.label || presetLabels[key] || key}
            </button>
          ))}
        </div>
      </div>
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            >
              ...
              <div>
                <div className="font-semibold text-sm">Single Word (Pop)</div>
                <p className="text-[10px] leading-tight text-text-secondary mt-1 opacity-80">
                  Satu kata per layar dengan animasi pop. (Gaya Hormozi)
                </p>
              </div>
            </button>
            ...
            >
              ...
              <div>
                <div className="font-semibold text-sm">Karaoke (Highlight)</div>
                <p className="text-[10px] leading-tight text-text-secondary mt-1 opacity-80">
                  Menampilkan kalimat dan menyorot kata yang sedang diucapkan.
                </p>
              </div>
            </button>
            ...
            >
              ...
              <div>
                <div className="font-semibold text-sm">Standar</div>
                <p className="text-[10px] leading-tight text-text-secondary mt-1 opacity-80">
                  Menampilkan kalimat penuh secara statis.
                </p>
              </div>
            </button>
          </div>
          ...
          <div className="lg:col-span-5">
            <div className="sticky top-4 space-y-2">
              <div className="flex items-center gap-2 text-xs font-semibold text-text-secondary uppercase tracking-wider">
                ...
                <span>Pratinjau Langsung Subtitle (Live Preview)</span>
              </div>
                ...
                >
                  {styleMode === "single_word" ? (
                    ...
                    <div className="flex items-center justify-center gap-1.5 flex-wrap">
                      <span>BUAT KONTEN JADI LEBIH</span>
                    ...
                    <span>
                      Buat konten video Anda menjadi viral
                    </span>
                  )}
                </div>
              ...
              <div className="space-y-5 pt-3 animate-slide-up border-t border-border/50">
                ...
                <div className="space-y-2">
                  <label className="text-label text-text-secondary font-medium flex items-center gap-2">
                    ...
                    <span>Jenis Huruf (Font Family)</span>
                  </label>
                ...
                <div className="space-y-2 pt-2 border-t border-border/50">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1">
                      <div className="flex justify-between items-center text-xs text-text-secondary mb-1">
                        <span>Horizontal (Kiri/Kanan)</span>
                        <span>{positionX}%</span>
                      </div>
                      <input
                        type="range"
                ...
                <div className="space-y-4 pt-2 border-t border-border/50">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <span className="text-xs text-text-secondary">Warna Teks Utama</span>
                      <div className="flex items-center gap-2">
                        <input
                          type="color"
                          value={textColor}
                          onChange={(e) => onChange({ ...config, text_color: e.target.value })}
                          className="w-8 h-8 rounded bg-transparent cursor-pointer border border-border"
                        />
                        <input
                          type="text"
                          value={textColor}
                    ...
                    <div className="space-y-2">
                      <span className="text-xs text-text-secondary">Warna Sorotan (Highlight)</span>
